...
public class CommonFileItemWriter<T> extends FlatFileItemWriter<T> {
    ...
    public CommonFileItemWriter(Class clz) {
        init(clz);
        fileSystemResource = new FileSystemResource("D:\\myspace\\java\\github\\SPRING-BATCH\\spring-batch-demo\\data\\"+ clz.getSimpleName() + ".csv");
    ...
    public CommonFileItemWriter(Class clz,String name) {
        init(clz);
        fileSystemResource = new FileSystemResource("D:\\myspace\\java\\github\\SPRING-BATCH\\spring-batch-demo\\data\\"+ name + ".csv");
        setResource(fileSystemResource);
